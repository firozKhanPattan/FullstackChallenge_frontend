...
- Rest Endpoints to expose resources using Springboot/Java8+/Maven etc
...
- You can communicate if you have a doubt or need some clarification or to understand the assignment.
...
For the airline logos,  You can add Flight logo.
...
NOTE :- You can modify this to use any other framework as per your strength.
...
Inspiration for the test format taken with ❤️ from [JustEat's recruitment test](https://github.com/justeat/JustEat.RecruitmentTest). and [skysscanner's recruitment test](https://github.com/Skyscanner/full-stack-recruitment-test)
